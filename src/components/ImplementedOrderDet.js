...
class ImplementedOrderDet extends Component {
    constructor(props){
        super(props);
                ...
                <Content  contentContainerStyle={styles.flexGrow} style={styles.homecontent}  onScroll={e => this.headerScrollingAnimation(e) }>
                    ...
                    <View style={styles.prodDet}>
                        ...
                        <View style={[styles.desc , styles.mt10 ]}>
                            ...
                            <View style={[styles.directionRowSpace , styles.w100 , styles.mb10 ]}>
                                <View style={styles.directionRowCenter}>
                                    ...
                                    <Text style={[styles.type ,{color:COLORS.labelBackground  }]}>اسم العميل</Text>
                                </View>
                        ...
                        <View style={[styles.desc , styles.mb25 , styles.mt15 ]}>
                            ...
                            <View style={[styles.directionRowSpace , styles.w100 ]}>
                                ...
                                <TouchableOpacity onPress={() => this.props.navigation.navigate('location')} style={{top:8}} >
                    ...
                    <Modal isVisible={this.state.reportModal} onBackdropPress={() => this.reportModal()}>
                        <View style={[styles.reportModal]}>
                            ...
                            <Text style={[styles.type ,{color:COLORS.boldgray , textAlign:'center' }]}>{ i18n.t('reportReason') }</Text>

                            <View style={[styles.mt30 ,styles.directionRow , styles.mb10]}>
                                <CheckBox checked={true} color={COLORS.labelBackground} style={[styles.checkBox , {borderColor:COLORS.labelBackground}]} />
                                <Text style={[styles.type ,{color:COLORS.mediumgray }]}>{ i18n.t('abuse') }</Text>
                            </View>
                            <View style={[styles.directionRow , styles.mb10]}>
                                <CheckBox checked={false} color={COLORS.labelBackground} style={[styles.checkBox , {borderColor:COLORS.labelBackground}]} />
                                <Text style={[styles.type ,{color:COLORS.mediumgray }]}>{ i18n.t('orderMistake') }</Text>
                            </View>
                            <View style={[styles.directionRow , styles.mb10]}>
                                <CheckBox checked={false} color={COLORS.labelBackground} style={[styles.checkBox , {borderColor:COLORS.labelBackground}]} />
                                <Text style={[styles.type ,{color:COLORS.mediumgray }]}>{ i18n.t('orderDelay') }</Text>
                            </View>
                            <View style={[styles.directionRow , styles.mb10]}>
                                <CheckBox checked={false} color={COLORS.labelBackground} style={[styles.checkBox , {borderColor:COLORS.labelBackground}]} />
                                <Text style={[styles.type ,{color:COLORS.mediumgray }]}>{ i18n.t('otherReasons') }</Text>
                            </View>

                            <Button onPress={() => [this.props.navigation.navigate('myOrders') ,this.reportModal() ]} style={[styles.loginBtn , styles.mt30]}>
...
export default ImplementedOrderDet;